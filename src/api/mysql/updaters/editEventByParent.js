    ...
    , parEventType)
{
    ...
    " WHERE parentID = "+byParentID+" AND eventType="+parEventType+";";
...
//var temp = await editEventByPar(1,1,0,"2025-04-27 12:00:00","1:00:00","testTitlePar","Written and edited by SQL!",0,1);
//console.log(temp);